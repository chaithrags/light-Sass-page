...
import sty from "./PlasmicButton.module.css"; // plasmic-import: WnBdUS-sUNaTG/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__t6Kp)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__tYdPq)}
                role={"img"}
              />
            ),
