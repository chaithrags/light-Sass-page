...
import sty from "./PlasmicLogo.module.css"; // plasmic-import: -K1kSmrrn58pG/css
import logosvgH2WGdEiaQzeKu from "./images/logosvg.svg"; // plasmic-import: h2wGDEiaQzeKU/picture
  ...
  const stateSpecs = React.useMemo(
    () => [
      ...
      },
      {
        path: "largeLogo",
        type: "private",
        initFunc: ($props, $state, $ctx) => $props.largeLogo
      }
    ],
